...
$aKey_tid="sfsdvf$%^xvxcxdfsd";


if(isset($_GET['akey']))
{
	if(intval(decode($_GET['akey']))>0) {
		$_SESSION["RF"]["subfolder"] = "teachers_content/".intval(decode($_GET['akey']));
...
$config = array(
	...
	*/
	...
	|
	*/
	'upload_dir' => '/wbms/public/uploads/source/',
	...
	|
	*/
	'current_path' => '../public/uploads/source/',
