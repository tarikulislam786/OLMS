                ...
                callback: function () {
                    ...
                    if ("" != a && "undefined" != typeof a) {
                        ...
                        ("" == n || "undefined" == typeof n) && (n = "none"), e.ajax({
                            ...
                            data: {path: t, new_mode: a, is_recursive: n}
                        }).done(function (e) {
                            "" != e && bootbox.alert(e)
                        })
                    }
    ...
    var j = "9.9.6", T = !0, I = 0, O = function () {
        ...
        contextActions: {
            copy_url: function (a) {
                ...
                if (console.log(n), n = n.replace(e("#base_url").val(), ""), n = n.replace(e("#cur_dir").val(), ""), t = 1 == e("#popup").val() ? window.opener : window.parent, "" != i)if (1 == e("#crossdomain").val())t.postMessage({
        ...
        apply_link = function (a, t) {
            ...
            if ("" != t)
                if (1 == e("#crossdomain").val())n.postMessage({
                    ...
                    //
                    //responsive_filemanager_callback(t);
                    //return_bank();
                var s = e("#" + t, n.document);

                    //alert(s.val(c));
                s.val(c).trigger("change"),
                "function" == typeof n.responsive_filemanager_callback && n.responsive_filemanager_callback(t), g()
            }
            else apply_any(c)
    },
