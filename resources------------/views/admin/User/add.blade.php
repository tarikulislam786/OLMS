...
@section('title', 'Admin User Registration')
    ...
    <div id="content" class="app-content" role="main">
        <div class="app-content-body ">
            ...
            <div class="bg-light lter b-b wrapper-md">
                <h1 class="m-n font-thin h3">Admin User Registration</h1>
            </div>
            <div class="wrapper-md">


                <div class="panel panel-default">
                    <div class="panel-heading font-bold">Add Admin User</div>
                    {{Session::get('message')}}
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 m-t">
                                ...
                                <br>
                                    <img src="" id="selected_preview_image"/>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <button type="submit" class="btn btn-sm btn-info">Add User</button>
                            {!! Form::close() !!}
