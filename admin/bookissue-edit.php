                ...
                <div class="box-content">
                    <form role="form"  action="" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="stid" disabled value="<?php echo $unserializedIssueDetails["stid"];?>" class="auto  form-control" id="stid" placeholder="Student ID" style="width:20%">
                            <!-- here we do same thing except disabled feature because disabled field value not posted -->
                            <input type="hidden" name="stid" value="<?php echo $unserializedIssueDetails["stid"];?>" class="auto  form-control" id="stid" placeholder="Student ID" style="width:20%">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" disabled value="<?php echo $unserializedIssueDetails["studentname"];?>" class="form-control studentname" placeholder="Student Name" name="studentname" style="width:20%">
                            <input type="hidden" value="<?php echo $unserializedIssueDetails["studentname"];?>" class="form-control studentname" placeholder="Student Name" name="studentname" style="width:20%">
